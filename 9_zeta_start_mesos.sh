...
echo "To use sane names for your cluster, run the #10 Script, install Marathon-native, start it, then install mesos-dns." 
echo "If you already established your ssh proxy session, you'll need to exit and then restablish it"
echo "Then you will be able to access the Mesos UI via: http://${ZETA_MESOS_LEADER}:${ZETA_MESOS_LEADER_PORT}"
echo ""
echo ""
